...
public class TestFixedAsciiColumn extends TestColumn<String> {
	...
	TestSample<String> wrapSample(String label, String[] array, int characteristics) {
		...
		for (int i = 0; i < array.length; i++) {
			if (array[i] != null) {
				byte[] b = Arrays.copyOf(array[i].getBytes(US_ASCII), 20);
				array[i] = new String(b, US_ASCII);
			}
		}

		FixedAsciiColumn column = FixedAsciiColumn.builder(characteristics).addAll(array).build();
	...
	Column<String> collect(Stream<String> stream) {
		return stream.collect(FixedAsciiColumn.collector());
	}
	...
	public void testParse() {
		...
		FixedAsciiColumn col;

		col = FixedAsciiColumn.of("2020-05-04", "2022-06-18");
		assertEquals(DateColumn.of(LocalDate.parse("2020-05-04"), LocalDate.parse("2022-06-18")), col.parseDate(),
				"parseDate");

		col = FixedAsciiColumn.of("1", "2");
		assertEquals(IntColumn.of(1, 2), col.parseInt(), "parseInt");
	}
