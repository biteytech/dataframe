...
abstract class NullableLongArrayColumn<E, I extends Column<E>, C extends LongArrayColumn<E, I, C>, N extends NullableColumn<E, I, C, N>> extends NullableColumn<E, I, C, N> {
	
	NullableLongArrayColumn(C column, BufferBitSet nonNulls, IntBuffer nullCounts, int offset, int size) {
