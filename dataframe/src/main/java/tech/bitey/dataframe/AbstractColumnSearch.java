...
enum AbstractColumnSearch {
	...
	static <E extends Comparable<E>> int search(AbstractColumn<E, ?, ?> col, E value, boolean first) {
	 ...
	 */
	static <E extends Comparable<E>> int binarySearch(AbstractColumn<E, ?, ?> col, int fromIndex, int toIndex, E key) {
