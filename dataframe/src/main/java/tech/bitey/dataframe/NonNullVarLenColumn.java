...
abstract class NonNullVarLenColumn<E extends Comparable<E>, I extends Column<E>, C extends NonNullVarLenColumn<E, I, C>> extends NonNullColumn<E, I, C> {
	...
	NonNullVarLenColumn(VarLenPacker<E> packer, ByteBuffer elements, ByteBuffer rawPointers, int offset, int size, int characteristics, boolean view) {
	...
	abstract C construct(ByteBuffer elements, ByteBuffer rawPointers, int offset, int size, int characteristics, boolean view);
