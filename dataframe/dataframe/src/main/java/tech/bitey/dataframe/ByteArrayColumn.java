...
abstract class ByteArrayColumn<E extends Comparable<? super E>, I extends Column<E>, C extends ByteArrayColumn<E, I, C>>
	...
	final SmallByteBuffer elements;

	ByteArrayColumn(BigByteBuffer buffer, ByteArrayPacker<E> packer, int offset, int size, int characteristics,
			boolean view) {
		super(buffer, offset, size, characteristics, view);

		this.packer = packer;
		this.elements = buffer.asByteBuffer();
	}
